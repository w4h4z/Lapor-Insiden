...
--
-- Host: 127.0.0.1
-- Generation Time: 01 Apr 2019 pada 01.37
...
(1, 4, NULL, NULL, '2019-02-12', '2019-03-24 06:01:49', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl risus, volutpat nec eleifend ac, tincidunt vitae mi. Duis id orci et neque volutpat faucibus ut a massa. Sed dapibus eleifend tristique. Pellentesque fringilla a mi nec tempus. Phasellus vel fermentum diam, quis commodo lorem. Interdum et malesuada fames ac ante ipsum primis in faucibus. Morbi hendrerit quis felis sed condimentum. Phasellus volutpat, felis ut molestie sodales, dolor ipsum ornare nulla, vitae tempor sem mauris id mauris. Mauris condimentum non lacus a convallis. Etiam faucibus justo a ligula maximus, eu vulputate lectus semper. Morbi id turpis dolor.', 'nama aset', 'lokasi aset', 'pemilik aset', 'bukti', 'Unauthorized System Access', NULL, NULL, 'uhi1312312', '1', '2019-02-27 17:58:28', 1),
(3, 3, NULL, NULL, '2019-03-01', '2019-03-23 14:09:46', 'kn', 'jn', 'kmk', 'km', '5a4efa45eae9b-logo-bssn_665_3741.jpg', 'Malware', NULL, NULL, 'UMCTK', '1', '2019-03-07 06:27:02', 0),
(4, 4, NULL, NULL, '2019-03-09', '2019-03-24 02:33:52', 'h bhjjjjjjjjjjjjjjbhbhbhb', 'jb', 'jnjn', 'n  ', 'Target_Semester_Genap_Adam_Waluyo.docx', 'Patched Software Exploitation', NULL, NULL, '3LHEM', '1', '2019-03-24 02:33:52', 0),
(5, 4, NULL, NULL, '2019-03-28', '2019-03-24 08:46:24', 'c', 'c', 'c', 'c', 'Target_Semester_Genap_Adam_Waluyo1.docx', 'indikator Serangan', NULL, NULL, 'NCBK4', '1', '2019-03-24 06:08:37', 0);
...
CREATE TABLE `chat` (
  ...
  `id_aduan` int(11) NOT NULL,
  `id_admin1` int(11) NOT NULL,
  `id_admin2` int(11) NOT NULL DEFAULT '0',
  `chat` text NOT NULL,
...
INSERT INTO `chat` (`id`, `id_aduan`, `id_admin1`, `id_admin2`, `chat`, `datetime`, `status`) VALUES
(1, 1, 1, 0, 'ffdfdf', '2019-03-23 15:35:47', 1),
(2, 1, 1, 0, 'sfsf', '2019-03-23 15:36:44', 1),
(3, 1, 1, 0, 'dfdsfdsf', '2019-03-23 15:39:58', 1),
(4, 1, 1, 0, 'dsgds', '2019-03-23 15:40:00', 1),
(5, 1, 1, 0, 'scdscdsv', '2019-03-23 15:42:29', 1),
(6, 1, 1, 0, 'scdscdsv', '2019-03-23 15:42:33', 1),
(8, 1, 1, 0, '------------------------------------------------------', '2019-03-24 05:39:30', 1),
(9, 1, 0, 0, 'skds', '2019-03-24 05:21:16', 0),
(10, 1, 0, 3, 'kkk', '2019-03-24 05:23:16', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `chat_pelapor`
--

CREATE TABLE `chat_pelapor` (
  `id` int(11) NOT NULL,
  `id_aduan` int(11) NOT NULL,
  `chat` text NOT NULL,
  `datetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
--
-- Indexes for table `chat_pelapor`
--
ALTER TABLE `chat_pelapor`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `aduan_siber`
  MODIFY `id_aduan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
-- AUTO_INCREMENT for table `chat_pelapor`
--
ALTER TABLE `chat_pelapor`
