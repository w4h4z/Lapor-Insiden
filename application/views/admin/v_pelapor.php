    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>
                             <form method="post" action="<?php echo base_url('admin/updatePelapor/'); ?><?php echo $data->id_pelapor;?>">
                    ...
                    <div id="organisasiDiv">
                    <div class="form-group row">
                      <label class="col-sm-12 col-form-label">Nama Organisasi</label>
                      <div class="col-sm-12">
                        <input type="text" class="form-control" id="namaOrg" value="<?php echo $data->nama_org;?>" name="namaOrg" placeholder="Nama Organisasi">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-12 col-form-label">Alamat Organisasi</label>
                      <div class="col-sm-12">
                        <textarea class="form-control" name="alamatOrg" id="alamatOrg" placeholder="Alamat Organisasi"><?php echo $data->alamat_org;?></textarea>
                      </div>
                    </div>
                    </div>
                    <div class="form-group row">
